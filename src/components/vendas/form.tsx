...
import { AutoComplete,
         ...
         AutoCompleteCompleteMethodParams } from 'primereact/autocomplete'
import { useState } from 'react'
import { Page } from 'app/models/common/page'
import { Copa } from 'app/models/copas'
import { Produto } from 'app/models/produtos'
import { useCopaService, useProdutoService } from 'app/services'
...
export const VendasForm: React.FC<VendasFormProps> = ({
    ...
    const handleClienteChange = (e: AutoCompleteChangeParams) => {
        const clienteSelecionado: Copa = e.value
        ...
        <form onSubmit={formik.handleSubmit}>
            <div className='p-fluid'>
                ...
                <div className='p-grid'>
                    ...
                    <div className='p-col-2'>
                        <span className='p-float-label'>
                            <InputText id="qtdProduto"
                                       ...
                                       />
                            <label htmlFor='qtdProduto'>QTDE</label>
                        </span>
                    </div>
                    ...
                    <div className='p-col-2'>
                        <div className='p-field'>
                            <label htmlFor="itens">Total:</label>
